...
var printerStyle = niceyaml.DefaultColorScheme().Default.
	PaddingRight(1).
	Width(60)
...
func demoHighlighting(dir string) {
	...
	printer := niceyaml.NewPrinter(
		...
		niceyaml.WithStyle(printerStyle),
	)
	...
	printer.AddStyleToRange(blueStyle, niceyaml.PositionRange{
		Start: niceyaml.Position{Line: 14, Col: 20},
		End:   niceyaml.Position{Line: 14, Col: 31}, // "or & Kaffe" - overlaps at "kor".
	})
