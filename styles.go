...
func DefaultColorScheme() ColorScheme {
	...
	return ColorScheme{
		...
		DiffInserted: base.Foreground(charmtone.Guac),  // GenericInserted.
		DiffDeleted:  base.Foreground(charmtone.Coral), // GenericDeleted.
	}
}
