// Package differ computes line differences between two [line.View] values
// and renders them as [line.Lines].
//
// A [Differ] compares the lines of two views, such as two niceyaml Source
// values or two [line.Lines] collections, with a [diff.Algorithm]. The
// default is [diff.Hirschberg]. Create one with [New], or call [Diff] for
