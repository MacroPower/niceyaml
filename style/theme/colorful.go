...
// Colorful returns [style.Styles] using colorful colors.
func Colorful() style.Styles {
	...
	return style.NewStyles(base,
		...
		style.Set(
			style.LiteralString,
			base.Background(lipgloss.Color("#fff0f0")),
		),
		style.Set(
			style.NameDecorator,
		...
		style.Set(
			...
			lipgloss.NewStyle().
				...
				Background(lipgloss.Color("#007700")).
				Bold(true),
		),
		style.Set(
		...
		style.Set(
			style.TextAccentDim,
			base.Foreground(lipgloss.Darken(lipgloss.Color("#007700"), 0.15)),
		),
		style.Set(
			style.TextAccent,
			base.Foreground(lipgloss.Color("#007700")),
