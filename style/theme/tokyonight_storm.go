...
// TokyonightStorm returns [style.Styles] using tokyonight-storm colors.
func TokyonightStorm() style.Styles {
	...
	return style.NewStyles(base,
		...
		style.Set(
			style.TextAccent,
			base.Foreground(lipgloss.Lighten(lipgloss.Color("#c0caf5"), 0.15)),
		),
		style.Set(
