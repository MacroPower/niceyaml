...
// Use options like [WithPath], [WithToken], and [WithSource] to enable
...
// WithToken sets the token where the error occurred.
...
// WithSource sets the YAML source bytes for annotating the error.
